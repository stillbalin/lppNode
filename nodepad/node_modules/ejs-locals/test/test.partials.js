...
describe('app',function(){
  ...
  describe('GET /collection/_entry',function(){
    it('should render _entry.ejs for every item with layout.html as layout',function(done){
      request(app)
  ...
  describe('GET /collection/thing-path',function(){
    it('should render thing/index.ejs for every item with layout.html as layout',function(done){
      request(app)
  ...
  describe('GET /subfolder/subitem',function(){
    it('should render subfolder/subitem.ejs and still use layout.html',function(done){
      request(app)
